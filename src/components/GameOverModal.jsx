...
const GameOverModal = () => {
  ...
  return (
    ...
    <div className={`inset fixed z-10 flex h-full w-full items-center justify-center bg-[rgba(0,0,0,0.4)] px-3 backdrop-blur-lg ${showModal ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"}  transition-opacity duration-300`}>
      <div className="border-2 border-light_brown max-w-[440px] items-center rounded-lg bg-white p-5 shadow-2xl">
        <div className="flex flex-grow flex-col items-center border-2 border-light_green border-dashed rounded-lg text-center w-[400px]">
          ...
          <p className="mb-4 mt-4 text-xl max-lg:text-lg">
          ...
          <button
            ...
            className="max-lg:2 mb-4 rounded-md border bg-purple-700 px-5 py-2.5 font-medium uppercase text-white hover:bg-purple-600 max-lg:px-4"
          >
            Play Again
          </button>
        </div>
